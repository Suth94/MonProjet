 ...
 */
public class CommentDialogActivity extends DialogFragment implements View.OnClickListener {
    ...
    interface CommentListener {
        ...
        void onComment(Comment rating);

    }

    private CommentListener mRatingListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof CommentListener) {
            mRatingListener = (CommentListener) context;
        }
    }
